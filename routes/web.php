...
Route::get('auth/github', [App\Http\Controllers\GithubController::class, 'redirectToProvider']);
Route::get('github/callback', [App\Http\Controllers\GithubController::class, 'handleProviderCallback']);
